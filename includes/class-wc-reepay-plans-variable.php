...
class WC_Reepay_Subscription_Plans_Variable extends WC_Reepay_Subscription_Plans {
    ...
    public function reepay_variable_create_subscription_product_class(){
        include_once( WooCommerce_Reepay_Subscriptions::$plugin_path . '/includes/class-wc-reepay-plan-variable-product.php' );
    }
    ...
    public function add_reepay_variable_type( $types ){
        $types['reepay_variable_subscriptions'] = __( 'Reepay Variable Subscription', WooCommerce_Reepay_Subscriptions::$domain );
