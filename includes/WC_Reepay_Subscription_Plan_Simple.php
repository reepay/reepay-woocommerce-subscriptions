...
class WC_Reepay_Subscription_Plan_Simple {
	...
	public function __construct() {
		...
		add_filter( 'woocommerce_cart_item_price', [ $this, 'cart_item_price_formatting' ], 10, 3 );
		add_filter( 'woocommerce_cart_item_subtotal', [ $this, 'cart_item_price_formatting' ], 10, 3 );
		add_filter( 'woocommerce_order_formatted_line_subtotal', [ $this, 'order_item_price_formatting' ], 10, 2 );

		add_action( 'woocommerce_before_calculate_totals', [ $this, 'add_setup_fee' ] );
	...
	protected function set_text_properties() {
		...
		self::$types_info = [
			WC_Reepay_Subscription_Plan_Simple::TYPE_DAILY               => __( 'Billed every day',
				'reepay-subscriptions-for-woocommerce' ),
			WC_Reepay_Subscription_Plan_Simple::TYPE_DAILY . '_multiple' => __( 'Billed every %s days',
				'reepay-subscriptions-for-woocommerce' ),

			WC_Reepay_Subscription_Plan_Simple::TYPE_MONTH_START_DATE               => __( 'Billed every month',
				'reepay-subscriptions-for-woocommerce' ),
			WC_Reepay_Subscription_Plan_Simple::TYPE_MONTH_START_DATE . '_multiple' => __( 'Billed every %s months',
				'reepay-subscriptions-for-woocommerce' ),

			WC_Reepay_Subscription_Plan_Simple::TYPE_MONTH_FIXED_DAY               => __( 'Billed every month',
				'reepay-subscriptions-for-woocommerce' ),
			WC_Reepay_Subscription_Plan_Simple::TYPE_MONTH_FIXED_DAY . '_multiple' => __( 'Billed every %s months',
				'reepay-subscriptions-for-woocommerce' ),

			WC_Reepay_Subscription_Plan_Simple::TYPE_MONTH_LAST_DAY               => __( 'Billed every month on the last day of the month',
				'reepay-subscriptions-for-woocommerce' ),
			WC_Reepay_Subscription_Plan_Simple::TYPE_MONTH_LAST_DAY . '_multiple' => __( 'Billed every %s months on the last day of the month',
				'reepay-subscriptions-for-woocommerce' ),

			WC_Reepay_Subscription_Plan_Simple::TYPE_PRIMO . '_multiple'         => __( 'Billed every %s months, on the first day of the month. The billing is fixed to these months: January, April, July, October',
				'reepay-subscriptions-for-woocommerce' ),
			WC_Reepay_Subscription_Plan_Simple::TYPE_ULTIMO . '_multiple'        => __( 'Billed every %s months, on the last day of the month. The billing is fixed to these months: January, April, July, October',
				'reepay-subscriptions-for-woocommerce' ),
			WC_Reepay_Subscription_Plan_Simple::TYPE_HALF_YEARLY . '_multiple'   => __( 'Billed every %s months, on the first day of the month. The billing is fixed to these months: January, July',
				'reepay-subscriptions-for-woocommerce' ),
			WC_Reepay_Subscription_Plan_Simple::TYPE_START_DATE_12 . '_multiple' => __( 'Billed every %s months, on the first day of the month. The billing is fixed to these months: January',
				'reepay-subscriptions-for-woocommerce' ),

			WC_Reepay_Subscription_Plan_Simple::TYPE_WEEKLY_FIXED_DAY               => __( 'Billed every Week',
				'reepay-subscriptions-for-woocommerce' ),
			WC_Reepay_Subscription_Plan_Simple::TYPE_WEEKLY_FIXED_DAY . '_multiple' => __( 'Billed every %s Weeks',
				'reepay-subscriptions-for-woocommerce' ),
		...
		self::$types_info_short = [
			WC_Reepay_Subscription_Plan_Simple::TYPE_DAILY               => __( 'Day',
				'reepay-subscriptions-for-woocommerce' ),
			WC_Reepay_Subscription_Plan_Simple::TYPE_DAILY . '_multiple' => __( '%s days',
				'reepay-subscriptions-for-woocommerce' ),

			WC_Reepay_Subscription_Plan_Simple::TYPE_MONTH_START_DATE               => __( 'Month',
				'reepay-subscriptions-for-woocommerce' ),
			WC_Reepay_Subscription_Plan_Simple::TYPE_MONTH_START_DATE . '_multiple' => __( '%s months',
				'reepay-subscriptions-for-woocommerce' ),

			WC_Reepay_Subscription_Plan_Simple::TYPE_MONTH_FIXED_DAY               => __( 'Month',
				'reepay-subscriptions-for-woocommerce' ),
			WC_Reepay_Subscription_Plan_Simple::TYPE_MONTH_FIXED_DAY . '_multiple' => __( '%s months',
				'reepay-subscriptions-for-woocommerce' ),

			WC_Reepay_Subscription_Plan_Simple::TYPE_MONTH_LAST_DAY               => __( 'Month',
				'reepay-subscriptions-for-woocommerce' ),
			WC_Reepay_Subscription_Plan_Simple::TYPE_MONTH_LAST_DAY . '_multiple' => __( '%s months',
				'reepay-subscriptions-for-woocommerce' ),

			WC_Reepay_Subscription_Plan_Simple::TYPE_PRIMO . '_multiple'         => __( '%s months',
				'reepay-subscriptions-for-woocommerce' ),
			WC_Reepay_Subscription_Plan_Simple::TYPE_ULTIMO . '_multiple'        => __( '%s months',
				'reepay-subscriptions-for-woocommerce' ),
			WC_Reepay_Subscription_Plan_Simple::TYPE_HALF_YEARLY . '_multiple'   => __( '%s months',
				'reepay-subscriptions-for-woocommerce' ),
			WC_Reepay_Subscription_Plan_Simple::TYPE_START_DATE_12 . '_multiple' => __( '%s months',
				'reepay-subscriptions-for-woocommerce' ),

			WC_Reepay_Subscription_Plan_Simple::TYPE_WEEKLY_FIXED_DAY               => __( 'Week',
				'reepay-subscriptions-for-woocommerce' ),
     ...
     * @return string
     */
    public function cart_item_price_formatting(string $price, array $cart_item, string $cart_item_key): string
    {
	 ...
	 * @return string
	 */
	public function order_item_price_formatting(string $subtotal, $item ): string {
		...
		if ( is_a( $product, 'WC_Product_Reepay_Simple_Subscription' ) ) {
			...
			return $product::format_price( $price, $product );
		}
		...
		foreach ( $cart->get_cart() as $cart_item ) {
			if ( WC_Reepay_Checkout::is_reepay_product( $cart_item['data'] ) ) {
				...
				if ( ! empty( $fee ) && ! empty( $fee['enabled'] ) && $fee['enabled'] == 'yes' ) {
					...
					$exist_fee = false;
					if ( ! empty( $fees ) ) {
						foreach ( $fees as $key => $fee_ ) {
							if ( $fee_->name == $product->get_name() . ' - ' . $fee["text"] ) {
								unset( $fees[ $key ] );
								$exist_fee = true;
							}
						}
