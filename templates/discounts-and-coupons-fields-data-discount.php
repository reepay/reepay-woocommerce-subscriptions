...
<p class="form-field">
    ...
    &nbsp<?php echo __( 'Fixed amount', 'reepay-subscriptions-for-woocommerce' ); ?>
</p>
<p class="form-field">
    <input
            type="radio"
    ...
    &nbsp<?php echo __( 'Percentage', 'reepay-subscriptions-for-woocommerce' ); ?>
</p>
<!--End Discount type-->
...
<p class="form-field">
    ...
    &nbsp<?php echo __( 'All', 'reepay-subscriptions-for-woocommerce' ); ?>
</p>
<p class="form-field">
    <input
            type="radio"
    ...
    &nbsp<?php echo __( 'Custom', 'reepay-subscriptions-for-woocommerce' ); ?>
</p>
...
<p class="form-field">
    ...
    &nbsp<?php echo __( 'Forever', 'reepay-subscriptions-for-woocommerce' ); ?>
</p>
<p class="form-field">
    <input
            type="radio"
    ...
    &nbsp<?php echo __( 'Fixed Number', 'reepay-subscriptions-for-woocommerce' ); ?>
</p>
...
<p class="form-field">
    ...
    />
    &nbsp<?php echo __( 'Limited Time', 'reepay-subscriptions-for-woocommerce' ); ?>
</p>
<p class="form-field show_if_limited_time">
    <label for="_reepay_discount_fixed_period"><?php echo __( 'Period Length', 'reepay-subscriptions-for-woocommerce' ); ?></label>
    <input
            type="number"
            min="1"
...
<p class="form-field show_if_limited_time">
    <label for="_reepay_discount_fixed_period_unit"><?php echo __( 'Unit', 'reepay-subscriptions-for-woocommerce' ); ?></label>
