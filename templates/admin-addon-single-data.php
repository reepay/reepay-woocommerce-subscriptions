...
<tr style="display: flex">
    <td class="addon_name" style="width: 33%">
        ...
        <input style="width: 100%;" type="number"
               ...
               id="addon_amount_<?php esc_html_e( $loop ); ?>"
               name="product_addon_amount[<?php esc_html_e( $loop ); ?>]"
...
<tr>
    <td class="addon_name">
        <p class="form-row choose-radio">
            <label><?php esc_html_e( 'Add-on availability', 'reepay-subscriptions' ); ?></label>
            &nbsp&nbsp<?php esc_html_e( 'Current plan', 'reepay-subscriptions' ); ?> &nbsp
            ...
            &nbsp&nbsp<?php esc_html_e( 'All plans', 'reepay-subscriptions' ); ?> &nbsp
            <input type="radio" id="_reepay_subscription_avai"
                   name="_reepay_addon_avai[<?php esc_html_e( $loop ); ?>]" <?php echo $addon['disabled'] ? 'disabled' : '' ?>
