<?php
	 ...
	 * @var array $payment_methods reepay payment methods
...
<table class="shop_table subscription_details">
	...
	<?php
		foreach ( $dates_to_display as $date_type => ['label' => $label, 'value' => $value] ) : ?><?php if ( ! empty( $value ) ) : ?>
            <tr>
	...
	<?php
		...
		if ( empty( $subscription['is_expired'] ) ): ?><?php if ( reepay_s()->settings( '_reepay_enable_on_hold' ) || reepay_s()->settings( '_reepay_enable_cancel' ) ): ?>
            <tr>
		...
		<?php endif; ?>
			...
			<?php if ( ! empty( $payment_methods['cards'] ) || ! empty( $payment_methods['mps_subscriptions'] ) ) : ?>
                <tr>
