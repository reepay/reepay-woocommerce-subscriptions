<script type="text/template" id="tmpl-reepay-subscriptions-import-data-table-customers">
    <h3> <?php _e('Customers', 'reepay-subscriptions-for-woocommerce') ?> (<%= amount %>)</h3>
    <table class="wp-list-table widefat fixed striped table-view-list reepay-import-table js-reepay-import-table" data-type="customers">
        ...
        <tr>
            ...
            <th scope="col" class="manage-column column-name"><?php _e('Name', 'reepay-subscriptions-for-woocommerce') ?></th>
            <th scope="col" class="manage-column column-email"><?php _e('Email', 'reepay-subscriptions-for-woocommerce') ?></th>
            <th scope="col" class="manage-column column-reepay-handle"><?php _e('Reepay Handle', 'reepay-subscriptions-for-woocommerce') ?></th>
        ...
        <% if(!Object.keys(rows).length) { %>
            <tr class="no-items"><td class="colspanchange" colspan="5"><?php _e('No customers found', 'reepay-subscriptions-for-woocommerce') ?></td></tr>
        <% } %>
