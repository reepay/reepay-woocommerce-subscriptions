...
<div class="options_group reepay_subscription_pricing show_if_reepay_subscription">
    <p class="form-field pricing-fields <?= $variable ? 'dimensions_field form-row' : '' ?> ">
        <label for="_subscription_price">
            <?php esc_html_e( 'Subscription pricing (kr)', WooCommerce_Reepay_Subscriptions::$domain ); ?>
        </label>
        <span class="wrap">
            <input type="number" id="_subscription_price" <?= $is_update ? 'disabled' : '' ?> name="_reepay_subscription_price" class="wc_input_price wc_input_subscription_price" placeholder="<?php esc_attr_e( 'e.g. 5.90', WooCommerce_Reepay_Subscriptions::$domain ); ?>" step="any" min="0" value="<?php echo esc_attr( wc_format_localized_price( $meta['_reepay_subscription_price'][0] ) ); ?>"/>
            <select id="_subscription_price_vat" <?= $is_update ? 'disabled' : '' ?> name="_reepay_subscription_vat" class="wc_input_subscription_period_interval">
                <option value="include" <?php selected( 'include', $meta['_reepay_subscription_vat'][0], true ) ?>><?php esc_html_e( 'Incl. VAT', WooCommerce_Reepay_Subscriptions::$domain ); ?></option>
                <option value="exclude" <?php selected( 'exclude', $meta['_reepay_subscription_vat'][0], true ) ?>><?php esc_html_e( 'Excl. VAT', WooCommerce_Reepay_Subscriptions::$domain ); ?></option>
            </select>
    ...
    <p class="form-field type-fields fields-daily <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_reepay_subscription_daily"><?php esc_html_e( 'Charge every', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        ...
        &nbsp<?php esc_html_e( 'Day', WooCommerce_Reepay_Subscriptions::$domain ); ?>
    </p>

    <!--Monthly-->
    <p class="form-field type-fields fields-month_startdate <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_month_startdate"><?php esc_html_e( 'Charge every', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        ...
        &nbsp<?php esc_html_e( 'Month', WooCommerce_Reepay_Subscriptions::$domain ); ?>
    </p>
    ...
    <p class="form-field type-fields fields-month_fixedday <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_month_fixedday"><?php esc_html_e( 'Charge every', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
    ...
    <p class="form-field type-fields fields-month_fixedday <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_month_fixedday_day"><?php esc_html_e( 'On this day of the month', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
    ...
    <p class="form-field type-fields fields-month_fixedday <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_month_fixedday_period"><?php esc_html_e( 'Partial Period Handling', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
    ...
    <p class="form-field type-fields fields-month_fixedday <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_month_fixedday_proration"><?php esc_html_e( 'Proration setting', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
    ...
    <p class="form-field type-fields fields-month_fixedday <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_month_fixedday_proration_minimum"><?php esc_html_e( 'Minimum prorated amount', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <input type="number" id="_subscription_month_fixedday_proration_minimum"  value="<?= !empty($month_fixedday['proration_minimum']) ? $month_fixedday['proration_minimum'] : 0?>"  name="_reepay_subscription_month_fixedday[proration_minimum]" placeholder="<?php esc_attr_e( 'kr 0.00', WooCommerce_Reepay_Subscriptions::$domain ); ?>"/>
    </p>
    ...
    <p class="form-field type-fields fields-month_lastday <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_month_lastday_period"><?php esc_html_e( 'Partial Period Handling', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
    ...
    <p class="form-field type-fields fields-month_lastday <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_month_lastday_proration"><?php esc_html_e( 'Proration setting', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
    ...
    <p class="form-field type-fields fields-month_lastday <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_month_lastday_proration_minimum"><?php esc_html_e( 'Minimum prorated amount', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <input type="number" id="_subscription_month_lastday_proration_minimum" value="<?= !empty($month_lastday['proration_minimum']) ? $month_lastday['proration_minimum'] : 0?>" name="_subscription_month_lastday[proration_minimum]" placeholder="<?php esc_attr_e( 'kr 0.00', WooCommerce_Reepay_Subscriptions::$domain ); ?>" value="<?php echo esc_attr( wc_format_localized_price( $chosen_price ) ); ?>" />
    </p>
    ...
    <p class="form-field type-fields fields-primo hidden">
        <label for="_subscription_primo"><?php _e( 'Charge first day of every', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <strong><?php _e( '3rd Month', WooCommerce_Reepay_Subscriptions::$domain ); ?></strong>
    </p>
    <p class="form-field type-fields fields-primo hidden">
        <label for="_subscription_primo"><?php _e( 'Fixed Months:', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <strong><?php _e( 'Jan, Apr, Jul, Oct', WooCommerce_Reepay_Subscriptions::$domain ); ?></strong>
    </p>
    <p class="form-field type-fields fields-primo <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_primo_period"><?php esc_html_e( 'Partial Period Handling', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
    ...
    <p class="form-field type-fields fields-primo <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_primo_proration"><?php esc_html_e( 'Proration setting', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
    ...
    <p class="form-field type-fields fields-primo <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_primo_proration_minimum"><?php esc_html_e( 'Minimum prorated amount', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <input type="number" id="_subscription_primo_proration_minimum" name="_reepay_subscription_primo[proration_minimum]" placeholder="<?php esc_attr_e( 'kr 0.00', WooCommerce_Reepay_Subscriptions::$domain ); ?>" value="<?= !empty($primo['proration_minimum']) ? $primo['proration_minimum'] : 0?>" />
    </p>
    ...
    <p class="form-field type-fields fields-ultimo hidden">
        <label for="_subscription_ultimo"><?php _e( 'Charge last day of every', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <strong><?php _e( '3rd Month', WooCommerce_Reepay_Subscriptions::$domain ); ?></strong>
    </p>
    <p class="form-field type-fields fields-ultimo hidden">
        <label for="_subscription_ultimo"><?php _e( 'Fixed Months:', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <strong><?php _e( 'Jan, Apr, Jul, Oct', WooCommerce_Reepay_Subscriptions::$domain ); ?></strong>
    </p>
    <p class="form-field type-fields fields-ultimo <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_ultimo_period"><?php esc_html_e( 'Partial Period Handling', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
    ...
    <p class="form-field type-fields fields-ultimo <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_ultimo_proration"><?php esc_html_e( 'Proration setting', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
    ...
    <p class="form-field type-fields fields-ultimo <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_ultimo_proration_minimum"><?php esc_html_e( 'Minimum prorated amount', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <input type="number" id="_subscription_ultimo_proration_minimum" name="_reepay_subscription_ultimo[proration_minimum]" placeholder="<?php esc_attr_e( 'kr 0.00', WooCommerce_Reepay_Subscriptions::$domain ); ?>"  value="<?= !empty($ultimo['proration_minimum']) ? $ultimo['proration_minimum'] : 0?>" />
    </p>
    ...
    <p class="form-field type-fields fields-half_yearly hidden">
        <label for="_subscription_half_yearly"><?php _e( 'Charge every', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <strong><?php _e( '6th Month', WooCommerce_Reepay_Subscriptions::$domain ); ?></strong>
    </p>
    <p class="form-field type-fields fields-half_yearly hidden">
        <label for="_subscription_half_yearly"><?php _e( 'On this day of the month:', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <strong><?php _e( '1st', WooCommerce_Reepay_Subscriptions::$domain ); ?></strong>
    </p>
    <p class="form-field type-fields fields-half_yearly hidden">
        <label for="_subscription_half_yearly"><?php _e( 'Fixed Months:', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <strong><?php _e( 'Jan, Jul', WooCommerce_Reepay_Subscriptions::$domain ); ?></strong>
    </p>
    <p class="form-field type-fields fields-half_yearly <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_half_yearly_period"><?php esc_html_e( 'Partial Period Handling', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
    ...
    <p class="form-field type-fields fields-half_yearly <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_half_yearly_proration"><?php esc_html_e( 'Proration setting', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
    ...
    <p class="form-field type-fields fields-half_yearly <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_half_yearly_proration_minimum"><?php esc_html_e( 'Minimum prorated amount', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <input type="number" id="_subscription_half_yearly_proration_minimum" name="_reepay_subscription_half_yearly[proration_minimum]" placeholder="<?php esc_attr_e( 'kr 0.00', WooCommerce_Reepay_Subscriptions::$domain ); ?>" value="<?= !empty($half_yearly['proration_minimum']) ? $half_yearly['proration_minimum'] : 0?>" />
    </p>
    ...
    <p class="form-field type-fields fields-month_startdate_12 <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_half_yearly"><?php _e( 'Charge every', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <strong><?php _e( '12th Month', WooCommerce_Reepay_Subscriptions::$domain ); ?></strong>
    </p>
    <p class="form-field type-fields fields-month_startdate_12 <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_month_startdate_12"><?php _e( 'On this day of the month:', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <strong><?php _e( '1st', WooCommerce_Reepay_Subscriptions::$domain ); ?></strong>
    </p>
    <p class="form-field type-fields fields-month_startdate_12 <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_month_startdate_12"><?php _e( 'Fixed Months:', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <strong><?php _e( 'Jan', WooCommerce_Reepay_Subscriptions::$domain ); ?></strong>
    </p>
    <p class="form-field type-fields fields-month_startdate_12 <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_month_startdate_12_period"><?php esc_html_e( 'Partial Period Handling', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
    ...
    <p class="form-field type-fields fields-month_startdate_12 <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_month_startdate_12_proration"><?php esc_html_e( 'Proration setting', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
    ...
    <p class="form-field type-fields fields-month_startdate_12 <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_month_startdate_12_proration_minimum"><?php esc_html_e( 'Minimum prorated amount', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <input type="number" id="_subscription_month_startdate_12_proration_minimum" name="_reepay_subscription_month_startdate_12[proration_minimum]" placeholder="<?php esc_attr_e( 'kr 0.00', WooCommerce_Reepay_Subscriptions::$domain ); ?>" value="<?= !empty($month_startdate_12['proration_minimum']) ? $month_startdate_12['proration_minimum'] : 0?>" />
    </p>
    ...
    <p class="form-field type-fields fields-weekly_fixedday <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_weekly_fixedday"><?php esc_html_e( 'Charge every', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <input type="number" id="_subscription_weekly_fixedday" <?= $is_update ? 'disabled' : '' ?> name="_reepay_subscription_weekly_fixedday[week]">
        &nbsp<?php esc_html_e( 'Week', WooCommerce_Reepay_Subscriptions::$domain ); ?>
    </p>
    <p class="form-field type-fields fields-weekly_fixedday <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_weekly_fixedday_day"><?php esc_html_e( 'On this day of the month', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
    ...
    <p class="form-field type-fields fields-weekly_fixedday <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_weekly_fixedday_period"><?php esc_html_e( 'Partial Period Handling', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
    ...
    <p class="form-field type-fields fields-weekly_fixedday <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_weekly_fixedday_proration"><?php esc_html_e( 'Proration setting', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
    ...
    <p class="form-field type-fields fields-weekly_fixedday <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_weekly_fixedday_proration_minimum"><?php esc_html_e( 'Minimum prorated amount', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <input type="number" id="_subscription_weekly_fixedday_proration_minimum" name="_reepay_subscription_weekly_fixedday[proration_minimum]" placeholder="<?php esc_attr_e( 'kr 0.00', WooCommerce_Reepay_Subscriptions::$domain ); ?>" value="<?= !empty($weekly_fixedday['proration_minimum']) ? $weekly_fixedday['proration_minimum'] : 0?>" />
    </p>

    <!--Advanced-->
    <p class="form-field advanced-fields <?= $variable ? 'dimensions_field form-row' : '' ?>">
        <label for="_reepay_subscription_renewal_reminder">
            <?php esc_html_e( 'Advanced', WooCommerce_Reepay_Subscriptions::$domain ); ?>
        </label>
        <span class="wrap">
            <input type="number" id="_reepay_subscription_renewal_reminder" name="_reepay_subscription_renewal_reminder" class="wc_input_price wc_input_subscription_price" placeholder="<?php esc_html_e( 'Renewal Reminder Schedule', WooCommerce_Reepay_Subscriptions::$domain ); ?>" value="<?php echo !empty($meta['_reepay_subscription_renewal_reminder'][0]) ? esc_attr($meta['_reepay_subscription_renewal_reminder'][0]) : ''?>"/>
            <input type="number" id="_reepay_subscription_default_quantity" <?= $is_update ? 'disabled' : '' ?> name="_reepay_subscription_default_quantity" class="wc_input_price wc_input_subscription_price" placeholder="<?php esc_html_e( 'Default Quantity', WooCommerce_Reepay_Subscriptions::$domain ); ?>" value="<?php echo !empty($meta['_reepay_subscription_default_quantity'][0]) ? esc_attr($meta['_reepay_subscription_default_quantity'][0]) : ''?>"/>
        </span>
    </p>
</div>
...
<div class="options_group show_if_reepay_subscription">
    <p class="form-field <?= $variable ? 'form-row' : '' ?>">
        <label for="_subscription_contract_periods"><?php esc_html_e( 'Minimum Contract Period', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <input type="number" id="_subscription_contract_periods" <?= $is_update ? 'disabled' : '' ?> name="_reepay_subscription_contract_periods" <?= $is_update ? 'disabled' : '' ?> placeholder="<?php esc_html_e( 'Periods', WooCommerce_Reepay_Subscriptions::$domain ); ?>" value="<?= !empty($meta['_reepay_subscription_contract_periods'][0]) ? $meta['_reepay_subscription_contract_periods'][0] : 0?>" />
    </p>
    <p class="form-field fields-contract_periods hidden">
        <label for="_reepay_subscription_contract_periods_full"></label>
        <?php esc_html_e( 'When the subscription is created', WooCommerce_Reepay_Subscriptions::$domain ); ?> &nbsp<input <?= $is_update ? 'disabled' : '' ?> type="radio" id="_reepay_subscription_contract_periods_full" name="_reepay_subscription_contract_periods_full" value="false" <?php checked( 'false', $meta['_reepay_subscription_contract_periods_full'][0], true ); ?>/>
        &nbsp&nbsp <?php esc_html_e( 'When the first period starts', WooCommerce_Reepay_Subscriptions::$domain ); ?> &nbsp<input <?= $is_update ? 'disabled' : '' ?> type="radio" id="_reepay_subscription_contract_periods_full" name="_reepay_subscription_contract_periods_full" value="true" <?php checked( 'true', $meta['_reepay_subscription_contract_periods_full'][0], true ); ?>/>
    </p>
</div>

<div class="options_group show_if_reepay_subscription">
    <p class="form-field">
        <label for="_subscription_notice_period"><?php esc_html_e( 'Notice period', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <input type="number" id="_subscription_notice_period" <?= $is_update ? 'disabled' : '' ?> name="_reepay_subscription_notice_period" placeholder="<?php esc_html_e( 'Periods', WooCommerce_Reepay_Subscriptions::$domain ); ?>" value="<?= !empty($meta['_reepay_subscription_notice_period'][0]) ? $meta['_reepay_subscription_notice_period'][0] : 0?>" />
    </p>
    <p class="form-field fields-notice_period hidden">
        <label for="_subscription_notice_period_start"></label>
        <?php esc_html_e( 'When the current cancelled period ends', WooCommerce_Reepay_Subscriptions::$domain ); ?> &nbsp<input <?= $is_update ? 'disabled' : '' ?> type="radio" id="_subscription_notice_period_start" name="_reepay_subscription_notice_period_start" value="true" <?php checked( 'true', $meta['_reepay_subscription_notice_period_start'][0], true ); ?>/>
        &nbsp&nbsp <?php esc_html_e( 'Immediately after cancellation', WooCommerce_Reepay_Subscriptions::$domain ); ?> &nbsp<input <?= $is_update ? 'disabled' : '' ?> type="radio" id="_subscription_notice_period_start" name="_reepay_subscription_notice_period_start" value="false" <?php checked( 'false', $meta['_reepay_subscription_notice_period_start'][0], true ); ?>/>
    </p>
</div>

<div class="options_group show_if_reepay_subscription">
    <p class="form-field <?= $variable ? 'form-row' : '' ?>">
        <label for="_subscription_billing_cycles"><?php esc_html_e( 'Billing Cycles', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <?php esc_html_e( 'Auto Renew until cancelled', WooCommerce_Reepay_Subscriptions::$domain ); ?> &nbsp<input type="radio" id="_subscription_billing_cycles" <?= $is_update ? 'disabled' : '' ?> name="_reepay_subscription_billing_cycles" value="false" <?php checked( 'false', $meta['_reepay_subscription_billing_cycles'][0], true ); ?>/>
        &nbsp&nbsp <?php esc_html_e( 'Fixed Number of billing cycles', WooCommerce_Reepay_Subscriptions::$domain ); ?> &nbsp<input type="radio" <?= $is_update ? 'disabled' : '' ?> id="_subscription_billing_cycles" name="_reepay_subscription_billing_cycles" value="true" <?php checked( 'true', $meta['_reepay_subscription_billing_cycles'][0], true ); ?>/>
    </p>
    <p class="form-field fields-billing_cycles <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_billing_cycles_period"><?php esc_html_e( 'Number of billing cycles', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
...
<div class="options_group reepay_subscription_trial show_if_reepay_subscription">
    <p class="form-field <?= $variable ? 'form-row' : '' ?>">
        <label for="_subscription_trial"><?php esc_html_e( 'Trial', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
    ...
    <p class="form-field trial-fields fields-customize <?= $variable ? 'form-row' : '' ?> hidden">
        <label for="_subscription_trial_length"><?php esc_html_e( 'Trial Length', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <input type="number" id="_subscription_trial_length" <?= $is_update ? 'disabled' : '' ?> name="_reepay_subscription_trial[length]" placeholder="<?php esc_html_e( 'Length', WooCommerce_Reepay_Subscriptions::$domain ); ?>" value="<?= !empty($trial['length']) ? $trial['length'] : 0?>" />
    ...
    <p class="form-field <?= $variable ? 'form-row' : '' ?>  trial-fields fields-7days fields-14days fields-1month fields-customize hidden">
        <label for="_subscription_billing_trial_reminder"><?php esc_html_e( 'Optional Trial Reminder Schedule', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <input type="number" id="_subscription_trial_reminder"  name="_reepay_subscription_trial[reminder]" placeholder="<?php esc_html_e( 'Days', WooCommerce_Reepay_Subscriptions::$domain ); ?>" value="<?= !empty($trial['reminder']) ? $trial['reminder'] : 0?>" />
    </p>
</div>
...
<div class="options_group reepay_subscription_fee show_if_reepay_subscription">
    <p class="form-field">
        <label for="_subscription_fee"><?php esc_html_e( 'Include setup fee', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
    ...
    <p class="form-field fee-fields <?= $variable ? 'dimensions_field form-row' : '' ?> hidden">
        <label for="_subscription_fee_amount"><?php esc_html_e( 'Setup Fee (kr)', WooCommerce_Reepay_Subscriptions::$domain ); ?></label>
        <span class="wrap">
            <input type="number" id="_subscription_fee_amount" name="_reepay_subscription_fee[amount]" class="wc_input_price wc_input_subscription_price" placeholder="<?php esc_attr_e( 'Amount', WooCommerce_Reepay_Subscriptions::$domain ); ?>" step="any" min="0" value="<?= !empty($fee['amount']) ? $fee['amount'] : 0?>" />
            <input type="text" id="_subscription_fee_text" name="_reepay_subscription_fee[text]" placeholder="<?php esc_attr_e( 'Text', WooCommerce_Reepay_Subscriptions::$domain ); ?>"  value="<?= !empty($fee['text']) ? $fee['text'] : ''?>" />
