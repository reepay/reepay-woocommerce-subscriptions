    ...
    <div class="options_group reepay_subscription_pricing show_if_reepay_subscription">
        <p class="form-field fields-name form-row">
            ...
            <input type="text" id="_reepay_subscription_name" <?php echo esc_attr( $disabled ) ?>
                   name="_reepay_subscription_name[<?php echo esc_attr( $loop ) ?>]"
                   value="<?php echo ! empty( $_reepay_subscription_name ) ? esc_attr( $_reepay_subscription_name ) : '' ?>">
        </p>
        <p class="form-field pricing-fields form-row ">
            <label for="_subscription_price">
				<?php echo __( 'Subscription pricing (kr)', 'reepay-subscriptions-for-woocommerce' ); ?>
            </label>
            <span class="wrap">
                <input type="number"
                       id="_subscription_price" <?php echo esc_attr( $disabled ) ?> name="_reepay_subscription_price[<?php echo esc_attr( $loop ) ?>]"
                       style="float: unset"
        ...
        <!--Daily-->
        <p class="form-field type-fields fields-daily form-row hidden">
            ...
            <input type="number" min="0" id="_reepay_subscription_daily" <?php echo esc_attr( $disabled ) ?>
                   name="_reepay_subscription_daily[<?php echo esc_attr( $loop ) ?>]"
        ...
        <!--Monthly-->
        <p class="form-field type-fields fields-month_startdate form-row hidden">
            ...
            <input type="number" min="0" id="_subscription_month_startdate" <?php echo esc_attr( $disabled ) ?>
                   name="_reepay_subscription_month_startdate[<?php echo esc_attr( $loop ) ?>]"
        ...
        <p class="form-field type-fields fields-month_fixedday form-row hidden">
            ...
            <input type="number" min="0" id="_subscription_month_fixedday" <?php echo esc_attr( $disabled ) ?>
                   name="_reepay_subscription_month_fixedday[<?php echo esc_attr( $loop ) ?>][month]"
        ...
        <p class="form-field type-fields fields-month_fixedday form-row hidden">
            ...
            <select id="_subscription_month_fixedday_day" <?php echo esc_attr( $disabled ) ?>
                    name="_reepay_subscription_month_fixedday[<?php echo esc_attr( $loop ) ?>][day]"
                    class="wc_input_subscription_period_interval">
				<?php for ( $i = 1; $i <= 28; $i ++ ) : ?>
        ...
        <p class="form-field type-fields fields-month_fixedday form-row hidden">
            ...
            <select id="_subscription_month_fixedday_period" <?php echo esc_attr( $disabled ) ?>
                    name="_reepay_subscription_month_fixedday[<?php echo esc_attr( $loop ) ?>][period]"
                    class="wc_input_subscription_period_interval">
        ...
        <p class="form-field type-fields fields-month_fixedday form-row hidden">
            ...
            <select id="_subscription_month_fixedday_proration" <?php echo esc_attr( $disabled ) ?>
                    name="_subscription_month_fixedday[<?php echo esc_attr( $loop ) ?>][proration]"
                    class="wc_input_subscription_period_interval">
        ...
        <p class="form-field type-fields fields-month_fixedday form-row hidden">
            ...
            <input type="number" min="0"
                   ...
                   name="_reepay_subscription_month_fixedday[<?php echo esc_attr( $loop ) ?>][proration_minimum]"
        ...
        <p class="form-field type-fields fields-month_lastday form-row hidden">
            <label for="_subscription_month_lastday[<?php echo esc_attr( $loop ) ?>][month]"><?php echo __( 'Charge every', 'reepay-subscriptions-for-woocommerce' ); ?></label>
            <input type="number" min="0"
                   id="_subscription_month_lastday[<?php echo esc_attr( $loop ) ?>][month]" <?php echo esc_attr( $disabled ) ?>
                   value="<?php echo ! empty( $month_lastday['month'] ) ? $month_lastday['month'] : 0 ?>"
                   name="_reepay_subscription_month_lastday[<?php echo esc_attr( $loop ) ?>][month]">
			<?php echo __( 'Month', 'reepay-subscriptions-for-woocommerce' ); ?>
        </p>
        <p class="form-field type-fields fields-month_lastday form-row hidden">
            ...
            <select id="_subscription_month_lastday_period" <?php echo esc_attr( $disabled ) ?>
                    name="_reepay_subscription_month_lastday[<?php echo esc_attr( $loop ) ?>][period]"
                    class="wc_input_subscription_period_interval">
        ...
        <p class="form-field type-fields fields-month_lastday form-row hidden">
            ...
            <select id="_subscription_month_lastday_proration" <?php echo esc_attr( $disabled ) ?>
                    name="_reepay_subscription_month_lastday[<?php echo esc_attr( $loop ) ?>][proration]"
                    class="wc_input_subscription_period_interval">
        ...
        <p class="form-field type-fields fields-month_lastday form-row hidden">
            ...
            <input type="number" min="0"
                   ...
                   name="_subscription_month_lastday[<?php echo esc_attr( $loop ) ?>][proration_minimum]"
                   placeholder="<?php echo esc_attr( 'kr 0.00', 'reepay-subscriptions-for-woocommerce' ); ?>"/>
        </p>
        ...
        <p class="form-field type-fields fields-primo form-row hidden">
            ...
            <select id="_subscription_primo_period" <?php echo esc_attr( $disabled ) ?>
                    name="_reepay_subscription_primo[<?php echo esc_attr( $loop ) ?>][period]"
                    class="wc_input_subscription_period_interval">
        ...
        <p class="form-field type-fields fields-primo form-row hidden">
            ...
            <select id="_subscription_primo_proration" <?php echo esc_attr( $disabled ) ?>
                    name="_reepay_subscription_primo[<?php echo esc_attr( $loop ) ?>][proration]"
                    class="wc_input_subscription_period_interval">
        ...
        <p class="form-field type-fields fields-primo form-row hidden">
            ...
            <input type="number" min="0" id="_subscription_primo_proration_minimum" <?php echo esc_attr( $disabled ) ?>
                   name="_reepay_subscription_primo[<?php echo esc_attr( $loop ) ?>][proration_minimum]"
                   placeholder="<?php echo esc_attr( 'kr 0.00', 'reepay-subscriptions-for-woocommerce' ); ?>"
        ...
        <p class="form-field type-fields fields-ultimo form-row hidden">
            ...
            <select id="_subscription_ultimo_period" <?php echo esc_attr( $disabled ) ?>
                    name="_reepay_subscription_ultimo[<?php echo esc_attr( $loop ) ?>][period]"
                    class="wc_input_subscription_period_interval">
        ...
        <p class="form-field type-fields fields-ultimo form-row hidden">
            ...
            <select id="_subscription_ultimo_proration" <?php echo esc_attr( $disabled ) ?>
                    name="_reepay_subscription_ultimo[<?php echo esc_attr( $loop ) ?>][proration]"
                    class="wc_input_subscription_period_interval">
        ...
        <p class="form-field type-fields fields-ultimo form-row hidden">
            ...
            <input type="number" min="0" id="_subscription_ultimo_proration_minimum" <?php echo esc_attr( $disabled ) ?>
                   name="_reepay_subscription_ultimo[<?php echo esc_attr( $loop ) ?>][proration_minimum]"
                   placeholder="<?php echo esc_attr( 'kr 0.00', 'reepay-subscriptions-for-woocommerce' ); ?>"
        ...
        <p class="form-field type-fields fields-half_yearly form-row hidden">
            ...
            <select id="_subscription_half_yearly_period" <?php echo esc_attr( $disabled ) ?>
                    name="_reepay_subscription_half_yearly[<?php echo esc_attr( $loop ) ?>][period]"
                    class="wc_input_subscription_period_interval">
        ...
        <p class="form-field type-fields fields-half_yearly form-row hidden">
            ...
            <select id="_subscription_half_yearly_proration" <?php echo esc_attr( $disabled ) ?>
                    name="_reepay_subscription_half_yearly[<?php echo esc_attr( $loop ) ?>][proration]"
                    class="wc_input_subscription_period_interval">
        ...
        <p class="form-field type-fields fields-half_yearly form-row hidden">
            ...
            <input type="number" min="0"
                   ...
                   name="_reepay_subscription_half_yearly[<?php echo esc_attr( $loop ) ?>][proration_minimum]"
                   placeholder="<?php echo esc_attr( 'kr 0.00', 'reepay-subscriptions-for-woocommerce' ); ?>"
        ...
        <p class="form-field type-fields fields-month_startdate_12 form-row hidden">
            <label for="_subscription_half_yearly"><?php _e( 'Charge every', 'reepay-subscriptions-for-woocommerce' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_startdate_12 form-row hidden">
            ...
            <select id="_subscription_month_startdate_12_period" <?php echo esc_attr( $disabled ) ?>
                    name="_reepay_subscription_month_startdate_12[<?php echo esc_attr( $loop ) ?>][period]"
                    class="wc_input_subscription_period_interval">
        ...
        <p class="form-field type-fields fields-month_startdate_12 form-row hidden">
            ...
            <select id="_subscription_month_startdate_12_proration" <?php echo esc_attr( $disabled ) ?>
                    name="_reepay_subscription_month_startdate_12[<?php echo esc_attr( $loop ) ?>][proration]"
                    class="wc_input_subscription_period_interval">
        ...
        <p class="form-field type-fields fields-month_startdate_12 form-row hidden">
            ...
            <input type="number" min="0"
                   ...
                   name="_reepay_subscription_month_startdate_12[<?php echo esc_attr( $loop ) ?>][proration_minimum]"
                   placeholder="<?php echo esc_attr( 'kr 0.00', 'reepay-subscriptions-for-woocommerce' ); ?>"
        ...
        <p class="form-field type-fields fields-weekly_fixedday form-row hidden">
            ...
            <input type="number" min="0" id="_subscription_weekly_fixedday" <?php echo esc_attr( $disabled ) ?>
                   name="_reepay_subscription_weekly_fixedday[<?php echo esc_attr( $loop ) ?>][week]">
        ...
        <p class="form-field type-fields fields-weekly_fixedday form-row hidden">
            ...
            <select id="_subscription_weekly_fixedday_day" <?php echo esc_attr( $disabled ) ?>
                    name="_reepay_subscription_weekly_fixedday[<?php echo esc_attr( $loop ) ?>][day]"
                    class="wc_input_subscription_period_interval">
        ...
        <p class="form-field type-fields fields-weekly_fixedday form-row hidden">
            ...
            <select id="_subscription_weekly_fixedday_period" <?php echo esc_attr( $disabled ) ?>
                    name="_reepay_subscription_weekly_fixedday[<?php echo esc_attr( $loop ) ?>][period]"
                    class="wc_input_subscription_period_interval">
        ...
        <p class="form-field type-fields fields-weekly_fixedday form-row hidden">
            ...
            <select id="_subscription_weekly_fixedday_proration" <?php echo esc_attr( $disabled ) ?>
                    name="_reepay_subscription_weekly_fixedday[<?php echo esc_attr( $loop ) ?>][proration]"
                    class="wc_input_subscription_period_interval">
        ...
        <p class="form-field type-fields fields-weekly_fixedday form-row hidden">
            ...
            <input type="number" min="0"
                   ...
                   name="_reepay_subscription_weekly_fixedday[<?php echo esc_attr( $loop ) ?>][proration_minimum]"
                   placeholder="<?php echo esc_attr( 'kr 0.00', 'reepay-subscriptions-for-woocommerce' ); ?>"
                   value="<?php echo ! empty( $weekly_fixedday['proration_minimum'] ) ? esc_attr( $weekly_fixedday['proration_minimum'] ) : 0 ?>"/>
        </p>

        <p class="form-field advanced-fields form-row">
            ...
            <input type="number" min="0" id="_reepay_subscription_default_quantity" <?php echo esc_attr( $disabled ) ?>
                   name="_reepay_subscription_default_quantity[<?php echo esc_attr( $loop ) ?>]"
                   class="wc_input_price wc_input_subscription_price"
        ...
        <p class="form-field advanced-fields form-row">
            ...
            <input type="number" min="0" id="_reepay_subscription_renewal_reminder" <?php echo esc_attr( $disabled ) ?>
                   name="_reepay_subscription_renewal_reminder[<?php echo esc_attr( $loop ) ?>]"
                   class="wc_input_price wc_input_subscription_price"
    ...
    <div class="options_group show_if_reepay_subscription">
        <p class="form-field form-row">
            ...
            <input type="number" min="0" id="_subscription_contract_periods" <?php echo esc_attr( $disabled ) ?>
                   name="_reepay_subscription_contract_periods[<?php echo esc_attr( $loop ) ?>]"
        ...
        <p class="form-field fields-contract_periods hidden">
            ...
            <input <?php echo esc_attr( $disabled ) ?>
                    ...
                    name="_reepay_subscription_contract_periods_full[<?php echo esc_attr( $loop ) ?>]"
    ...
    <div class="options_group show_if_reepay_subscription">
        <p class="form-field">
            ...
            <input type="number" min="0" id="_subscription_notice_period" <?php echo esc_attr( $disabled ) ?>
                   name="_reepay_subscription_notice_period[<?php echo esc_attr( $loop ) ?>]"
                   placeholder="<?php echo __( 'Periods', 'reepay-subscriptions-for-woocommerce' ); ?>"
        ...
        <p class="form-field fields-notice_period hidden">
			...
			<?php echo __( 'When the current cancelled period ends', 'reepay-subscriptions-for-woocommerce' ); ?> <input
                    ...
                    name="_reepay_subscription_notice_period_start[<?php echo esc_attr( $loop ) ?>]"
    ...
    <div class="options_group show_if_reepay_subscription billing_cycles_block">
        <p class="form-field form-row">
			...
			<?php echo __( 'Auto Renew until cancelled', 'reepay-subscriptions-for-woocommerce' ); ?> <input type="radio"
                                                                                             ...
                                                                                             name="_reepay_subscription_billing_cycles[<?php echo esc_attr( $loop ) ?>]"
        ...
        <p class="form-field fields-billing_cycles form-row hidden">
            ...
            <input type="number" min="0" id="_subscription_billing_cycles_period"
                   name="_reepay_subscription_billing_cycles_period[<?php echo esc_attr( $loop ) ?>]" <?php echo esc_attr( $disabled ) ?>
                   placeholder="*"
    ...
    <div class="options_group reepay_subscription_trial show_if_reepay_subscription">
        <p class="form-field form-row">
            ...
            <select id="_subscription_trial" <?php echo esc_attr( $disabled ) ?>
                    name="_reepay_subscription_trial[<?php echo esc_attr( $loop ) ?>][type]"
                    class="wc_input_subscription_period_interval">
        ...
        <p class="form-field trial-fields fields-customize form-row hidden">
            ...
            <input type="number" min="0" id="_subscription_trial_length" <?php echo esc_attr( $disabled ) ?>
                   name="_reepay_subscription_trial[<?php echo esc_attr( $loop ) ?>][length]"
            ...
            <select id="_subscription_trial_unit" <?php echo esc_attr( $disabled ) ?>
                    name="_reepay_subscription_trial[<?php echo esc_attr( $loop ) ?>][unit]"
                    class="wc_input_subscription_period_interval">
        ...
        <p class="form-field form-row  trial-fields fields-7days fields-14days fields-1month fields-customize hidden">
            ...
            <input type="number" min="0" id="_subscription_trial_reminder" <?php echo esc_attr( $disabled ) ?>
                   name="_reepay_subscription_trial[<?php echo esc_attr( $loop ) ?>][reminder]"
...
<?php $fee = ! empty( $_reepay_subscription_fee ) ? $_reepay_subscription_fee : [] ?>
    <div class="options_group reepay_subscription_fee show_if_reepay_subscription">
        ...
        <p class="form-field fee-fields form-row hidden">
            ...
            <span class="wrap">
            <input type="number" min="0"
                   id="_subscription_fee_amount" <?php echo esc_attr( $disabled ) ?> name="_reepay_subscription_fee[<?php echo esc_attr( $loop ) ?>][amount]"
                   class="wc_input_price wc_input_subscription_price"
            ...
            <input type="text"
                   id="_subscription_fee_text" <?php echo esc_attr( $disabled ) ?> name="_reepay_subscription_fee[<?php echo esc_attr( $loop ) ?>][text]"
                   placeholder="<?php echo esc_attr( 'Text', 'reepay-subscriptions-for-woocommerce' ); ?>"
                   value="<?php echo ! empty( $fee['text'] ) ? esc_attr( $fee['text'] ) : '' ?>"/>
            <select id="_subscription_fee_handling" <?php echo esc_attr( $disabled ) ?> name="_reepay_subscription_fee[<?php echo esc_attr( $loop ) ?>][handling]"
                    class="wc_input_subscription_period_interval">
    ...
    <div class="options_group show_if_reepay_subscription reepay_subscription_supersedes_block">
        <p class="form-field supersedes_block_variable">
            ...
            <input type="radio"
                   ...
                   name="_reepay_subscription_supersedes[<?php echo esc_attr( $loop ) ?>]"
