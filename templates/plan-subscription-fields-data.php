...
?>
    <div class="options_group reepay_subscription_pricing show_if_reepay_subscription">
        <p class="form-field fields-name <?php echo $variable ? 'form-row' : '' ?>">
            <label for="_reepay_subscription_name"><?php echo __( 'Name', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field pricing-fields <?php echo $variable ? 'dimensions_field form-row' : '' ?> ">
            <label for="_subscription_price">
				<?php echo __( 'Subscription pricing (kr)', 'reepay-subscriptions' ); ?>
            </label>
            <span class="wrap">
                <input type="number"
                       ...
                       placeholder="<?php echo esc_attr( 'e.g. 5.90', 'reepay-subscriptions' ); ?>" step="any" min="0"
        ...
        <p class="form-field pricing-fields <?php echo $variable ? 'form-row' : '' ?>">
            <label for="_subscription_schedule_type"><?php echo __( 'Schedule Type', 'reepay-subscriptions' ); ?></label>
            <select id="_subscription_schedule_type" <?php echo esc_attr( $disabled ) ?>
				...
				<?php foreach ( WC_Reepay_Subscription_Plan_Simple::$schedule_types as $value => $label ) { ?>
                    <option value="<?php echo esc_attr( $value ); ?>" <?php echo ! empty( $_reepay_subscription_schedule_type ) ? selected( $value, $_reepay_subscription_schedule_type, false ) : '' ?>><?php esc_html_e( $label, 'reepay-subscriptions' ); ?></option>
				<?php } ?>
            </select>
        </p>
        ...
        <p class="form-field type-fields fields-daily <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_reepay_subscription_daily"><?php echo __( 'Charge every', 'reepay-subscriptions' ); ?></label>
			...
			<?php echo __( 'Day', 'reepay-subscriptions' ); ?>
        </p>

        <!--Monthly-->
        <p class="form-field type-fields fields-month_startdate <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_startdate"><?php echo __( 'Charge every', 'reepay-subscriptions' ); ?></label>
			...
			<?php echo __( 'Month', 'reepay-subscriptions' ); ?>
        </p>
        ...
        <p class="form-field type-fields fields-month_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_fixedday"><?php echo __( 'Charge every', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_fixedday_day"><?php echo __( 'On this day of the month', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_fixedday_period"><?php echo __( 'Partial Period Handling', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_fixedday_proration"><?php echo __( 'Proration setting', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_fixedday_proration_minimum"><?php echo __( 'Minimum prorated amount', 'reepay-subscriptions' ); ?></label>
            <input type="number" min="0"
                   ...
                   placeholder="<?php echo esc_attr( 'kr 0.00', 'reepay-subscriptions' ); ?>"/>
        </p>
        ...
        <p class="form-field type-fields fields-month_lastday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_lastday<?php echo $variable ? '[' . esc_attr( $loop ) . ']' : '' ?>[month]"><?php echo __( 'Charge every', 'reepay-subscriptions' ); ?></label>
            <input type="number" min="0"
        ...
        <p class="form-field type-fields fields-month_lastday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_lastday_period"><?php echo __( 'Partial Period Handling', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_lastday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_lastday_proration"><?php echo __( 'Proration setting', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_lastday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_lastday_proration_minimum"><?php echo __( 'Minimum prorated amount', 'reepay-subscriptions' ); ?></label>
            <input type="number" min="0"
        ...
        <p class="form-field type-fields fields-primo hidden">
            <label for="_subscription_primo"><?php _e( 'Charge first day of every', 'reepay-subscriptions' ); ?></label>
            <strong><?php _e( '3rd Month', 'reepay-subscriptions' ); ?></strong>
        </p>
        <p class="form-field type-fields fields-primo hidden">
            <label for="_subscription_primo"><?php _e( 'Fixed Months:', 'reepay-subscriptions' ); ?></label>
            <strong><?php _e( 'Jan, Apr, Jul, Oct', 'reepay-subscriptions' ); ?></strong>
        </p>
        <p class="form-field type-fields fields-primo <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_primo_period"><?php echo __( 'Partial Period Handling', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-primo <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_primo_proration"><?php echo __( 'Proration setting', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-primo <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_primo_proration_minimum"><?php echo __( 'Minimum prorated amount', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-ultimo hidden">
            <label for="_subscription_ultimo"><?php _e( 'Charge last day of every', 'reepay-subscriptions' ); ?></label>
            <strong><?php _e( '3rd Month', 'reepay-subscriptions' ); ?></strong>
        </p>
        <p class="form-field type-fields fields-ultimo hidden">
            <label for="_subscription_ultimo"><?php _e( 'Fixed Months:', 'reepay-subscriptions' ); ?></label>
            <strong><?php _e( 'Jan, Apr, Jul, Oct', 'reepay-subscriptions' ); ?></strong>
        </p>
        <p class="form-field type-fields fields-ultimo <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_ultimo_period"><?php echo __( 'Partial Period Handling', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-ultimo <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_ultimo_proration"><?php echo __( 'Proration setting', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-ultimo <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_ultimo_proration_minimum"><?php echo __( 'Minimum prorated amount', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-half_yearly hidden">
            <label for="_subscription_half_yearly"><?php _e( 'Charge every', 'reepay-subscriptions' ); ?></label>
            <strong><?php _e( '6th Month', 'reepay-subscriptions' ); ?></strong>
        </p>
        <p class="form-field type-fields fields-half_yearly hidden">
            <label for="_subscription_half_yearly"><?php _e( 'On this day of the month:', 'reepay-subscriptions' ); ?></label>
            <strong><?php _e( '1st', 'reepay-subscriptions' ); ?></strong>
        </p>
        <p class="form-field type-fields fields-half_yearly hidden">
            <label for="_subscription_half_yearly"><?php _e( 'Fixed Months:', 'reepay-subscriptions' ); ?></label>
            <strong><?php _e( 'Jan, Jul', 'reepay-subscriptions' ); ?></strong>
        </p>
        <p class="form-field type-fields fields-half_yearly <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_half_yearly_period"><?php echo __( 'Partial Period Handling', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-half_yearly <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_half_yearly_proration"><?php echo __( 'Proration setting', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-half_yearly <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_half_yearly_proration_minimum"><?php echo __( 'Minimum prorated amount', 'reepay-subscriptions' ); ?></label>
            <input type="number" min="0"
        ...
        <p class="form-field type-fields fields-month_startdate_12 <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_half_yearly"><?php _e( 'Charge every', 'reepay-subscriptions' ); ?></label>
            <strong><?php _e( '12th Month', 'reepay-subscriptions' ); ?></strong>
        </p>
        <p class="form-field type-fields fields-month_startdate_12 <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_startdate_12"><?php _e( 'On this day of the month:', 'reepay-subscriptions' ); ?></label>
            <strong><?php _e( '1st', 'reepay-subscriptions' ); ?></strong>
        </p>
        <p class="form-field type-fields fields-month_startdate_12 <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_startdate_12"><?php _e( 'Fixed Months:', 'reepay-subscriptions' ); ?></label>
            <strong><?php _e( 'Jan', 'reepay-subscriptions' ); ?></strong>
        </p>
        <p class="form-field type-fields fields-month_startdate_12 <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_startdate_12_period"><?php echo __( 'Partial Period Handling', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_startdate_12 <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_startdate_12_proration"><?php echo __( 'Proration setting', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_startdate_12 <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_startdate_12_proration_minimum"><?php echo __( 'Minimum prorated amount', 'reepay-subscriptions' ); ?></label>
            <input type="number" min="0"
        ...
        <p class="form-field type-fields fields-weekly_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_weekly_fixedday"><?php echo __( 'Charge every', 'reepay-subscriptions' ); ?></label>
			...
			<?php echo __( 'Week', 'reepay-subscriptions' ); ?>
        </p>
        <p class="form-field type-fields fields-weekly_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_weekly_fixedday_day"><?php echo __( 'On this day of the week', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-weekly_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_weekly_fixedday_period"><?php echo __( 'Partial Period Handling', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-weekly_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_weekly_fixedday_proration"><?php echo __( 'Proration setting', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-weekly_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_weekly_fixedday_proration_minimum"><?php echo __( 'Minimum prorated amount', 'reepay-subscriptions' ); ?></label>
            <input type="number" min="0"
        ...
        <p class="form-field advanced-fields <?php echo $variable ? 'form-row' : '' ?>">
            <label for="_reepay_subscription_default_quantity">
				<?php echo __( 'Default Quantity', 'reepay-subscriptions' ); ?>
            </label>
			<?php echo wc_help_tip( __( 'Default quantity to use when creating a new subscription. Also used as the quantity on hosted pages.', 'reepay-subscriptions' ) ); ?>
            <input type="number" min="0" id="_reepay_subscription_default_quantity" <?php echo esc_attr( $disabled ) ?>
                   ...
                   class="wc_input_price wc_input_subscription_price"
                   placeholder="<?php echo __( 'Default Quantity', 'reepay-subscriptions' ); ?>"
        ...
        <p class="form-field advanced-fields <?php echo $variable ? 'form-row' : '' ?>">
            <label for="_reepay_subscription_renewal_reminder">
				<?php echo __( 'Renewal Reminder', 'reepay-subscriptions' ); ?>
            </label>
            <input type="number" min="0" id="_reepay_subscription_renewal_reminder" <?php echo esc_attr( $disabled ) ?>
                   ...
                   class="wc_input_price wc_input_subscription_price"
                   placeholder="<?php echo __( 'Renewal Reminder Schedule', 'reepay-subscriptions' ); ?>"
    ...
    <div class="options_group show_if_reepay_subscription">
        <p class="form-field <?php echo $variable ? 'form-row' : '' ?>">
            <label for="_subscription_contract_periods"><?php echo __( 'Minimum Contract Period', 'reepay-subscriptions' ); ?></label>
			<?php echo wc_help_tip( __( 'Periods are relative to the billing frequency. If you have chosen to bill every month, a period is one month.', 'reepay-subscriptions' ) ); ?>
            <input type="number" min="0" id="_subscription_contract_periods" <?php echo esc_attr( $disabled ) ?>
                   ...
                   placeholder="<?php echo __( 'Periods', 'reepay-subscriptions' ); ?>"
        ...
        <p class="form-field fields-contract_periods hidden">
			...
			<?php echo __( 'When the subscription is created', 'reepay-subscriptions' ); ?>
			...
			<?php echo __( 'When the first period starts', 'reepay-subscriptions' ); ?>
            <input <?php echo esc_attr( $disabled ) ?>
    ...
    <div class="options_group show_if_reepay_subscription">
        <p class="form-field">
            <label for="_subscription_notice_period"><?php echo __( 'Notice period', 'reepay-subscriptions' ); ?></label>
			<?php echo wc_help_tip( __( 'Periods are relative to the billing frequency. If you have chosen to bill every month, a period is one month.', 'reepay-subscriptions' ) ); ?>
        ...
        <p class="form-field fields-notice_period hidden">
			...
			<?php echo __( 'When the current cancelled period ends', 'reepay-subscriptions' ); ?> <input
                    type="radio"
			...
			<?php echo __( 'Immediately after cancellation', 'reepay-subscriptions' ); ?> <input
                    type="radio"
                    id="_subscription_notice_period_start"
                    name="_reepay_subscription_notice_period_start<?php echo $variable ? '[' . esc_attr( $loop ) . ']' : '' ?>"
    ...
    <div class="options_group show_if_reepay_subscription billing_cycles_block">
        <p class="form-field <?php echo $variable ? 'form-row' : '' ?>">
            <label for="_subscription_billing_cycles"><?php echo __( 'Billing Cycles', 'reepay-subscriptions' ); ?></label>
			<?php echo __( 'Auto Renew until cancelled', 'reepay-subscriptions' ); ?> <input type="radio"
			...
			<?php echo __( 'Fixed Number of billing cycles', 'reepay-subscriptions' ); ?> <input
                    type="radio"
                    id="_subscription_billing_cycles" <?php echo esc_attr( $disabled ) ?>
                    name="_reepay_subscription_billing_cycles<?php echo $variable ? '[' . esc_attr( $loop ) . ']' : '' ?>"
        ...
        <p class="form-field fields-billing_cycles <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_billing_cycles_period"><?php echo __( 'Number of billing cycles', 'reepay-subscriptions' ); ?></label>
...
<?php $trial = ! empty( $_reepay_subscription_trial ) ? $_reepay_subscription_trial : [] ?>
    <div class="options_group reepay_subscription_trial show_if_reepay_subscription">
        <p class="form-field <?php echo $variable ? 'form-row' : '' ?>">
            <label for="_subscription_trial"><?php echo __( 'Trial', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field trial-fields fields-customize <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_trial_length"><?php echo __( 'Trial Length', 'reepay-subscriptions' ); ?></label>
            <input type="number" min="0" id="_subscription_trial_length" <?php echo esc_attr( $disabled ) ?>
                   ...
                   placeholder="<?php echo __( 'Length', 'reepay-subscriptions' ); ?>"
        ...
        <p class="form-field <?php echo $variable ? 'form-row' : '' ?>  trial-fields fields-7days fields-14days fields-1month fields-customize hidden">
            <label for="_subscription_trial_reminder"><?php echo __( 'Optional Trial Reminder Schedule', 'reepay-subscriptions' ); ?></label>
            <input type="number" min="0" id="_subscription_trial_reminder" <?php echo esc_attr( $disabled ) ?>
                   ...
                   placeholder="<?php echo __( 'Days', 'reepay-subscriptions' ); ?>"
...
<?php $fee = ! empty( $_reepay_subscription_fee ) ? $_reepay_subscription_fee : [] ?>
    <div class="options_group reepay_subscription_fee show_if_reepay_subscription">
        <p class="form-field">
            <label for="_subscription_fee"><?php echo __( 'Include setup fee', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field fee-fields <?php echo $variable ? 'dimensions_field form-row' : '' ?> hidden">
            <label for="_subscription_fee_amount"><?php echo __( 'Setup Fee (kr)', 'reepay-subscriptions' ); ?></label>
            <span class="wrap">
            <input type="number" min="0"
                   ...
                   class="wc_input_price wc_input_subscription_price"
                   placeholder="<?php echo esc_attr( 'Amount', 'reepay-subscriptions' ); ?>" step="any" min="0"
            ...
            <input type="text"
                   ...
                   placeholder="<?php echo esc_attr( 'Text', 'reepay-subscriptions' ); ?>"
            ...
            <select id="_subscription_fee_handling" <?php echo esc_attr( $disabled ) ?> name="_reepay_subscription_fee<?php echo $variable ? '[' . esc_attr( $loop ) . ']' : '' ?>[handling]"
                    class="wc_input_subscription_period_interval">
                <option value="first" <?php echo ! empty( $fee['handling'] ) ? selected( 'first', $fee['handling'], false ) : '' ?>><?php echo __( 'Include setup fee as order line on the first scheduled invoice', 'reepay-subscriptions' ); ?></option>
                <option value="separate" <?php echo ! empty( $fee['handling'] ) ? selected( 'separate', $fee['handling'], false ) : '' ?>><?php echo __( 'Create a separate invoice for the setup fee', 'reepay-subscriptions' ); ?></option>
                <option value="separate_conditional" <?php echo ! empty( $fee['handling'] ) ? selected( 'separate_conditional', $fee['handling'], false ) : '' ?>><?php echo __( 'Create a separate invoice for the setup fee, if the first invoice is not created in conjunction with the creation', 'reepay-subscriptions' ); ?></option>
            </select>
        </span>
        </p>
    </div>
		...
		if ( ! empty( $product_object ) && function_exists( 'woocommerce_wp_select' ) ) {
			woocommerce_wp_select(
				[
					...
					'label'             => __( 'Tax status', 'reepay-subscriptions' ),
					'options'           => [
						'taxable'  => __( 'Taxable', 'reepay-subscriptions' ),
						'shipping' => __( 'Shipping only', 'reepay-subscriptions' ),
						'none'     => _x( 'None', 'Tax status', 'reepay-subscriptions' ),
					],
					'desc_tip'          => 'true',
					'description'       => __( 'Define whether or not the entire product is taxable, or just the cost of shipping it.', 'reepay-subscriptions' ),
			...
			woocommerce_wp_select(
				[
					...
					'label'             => __( 'Tax class', 'reepay-subscriptions' ),
					'options'           => wc_get_product_tax_class_options(),
					'desc_tip'          => 'true',
					'description'       => __( 'Choose a tax class for this product. Tax classes are used to apply different tax rates specific to certain types of product.', 'reepay-subscriptions' ),
					'custom_attributes' => empty( $disabled ) ? [] : [ 'disabled' => 'disabled' ]
				]
			);
		}
...
<?php if ( isset( $is_exist ) && $is_exist ):
    ...
    <div class="options_group show_if_reepay_subscription reepay_subscription_supersedes_block">
        <p class="form-field <?php echo $variable ? 'supersedes_block_variable"' : '' ?>">
            <label for="_reepay_subscription_supersedes"><?php echo __( 'Supersede mode', 'reepay-subscriptions' ); ?></label>
			<?php echo __( "Don't schedule subscription update", 'reepay-subscriptions' ); ?>
			...
			<?php echo __( 'Schedule subscription update', 'reepay-subscriptions' ); ?>
