...
?>
    <div class="options_group reepay_subscription_pricing show_if_reepay_subscription">
        <p class="form-field fields-name <?php echo $variable ? 'form-row' : '' ?>">
            <label for="_reepay_subscription_name"><?php echo esc_html( 'Name', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field pricing-fields <?php echo $variable ? 'dimensions_field form-row' : '' ?> ">
            <label for="_subscription_price">
				<?php echo esc_html( 'Subscription pricing (kr)', 'reepay-subscriptions' ); ?>
            </label>
            <span class="wrap">
                <input type="number"
        ...
        <p class="form-field pricing-fields <?php echo $variable ? 'form-row' : '' ?>">
            ...
            <select id="_subscription_schedule_type" <?php echo esc_attr( $disabled ) ?>
				...
				<?php foreach ( WC_Reepay_Subscription_Plan_Simple::$schedule_types as $value => $label ) { ?>
                    <option value="<?php echo esc_attr( $value ); ?>" <?php echo ! empty( $_reepay_subscription_schedule_type ) ? selected( $value, $_reepay_subscription_schedule_type, false ) : '' ?>><?php echo esc_html( $label ); ?></option>
				<?php } ?>
            </select>
        </p>
        ...
        <p class="form-field type-fields fields-daily <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_reepay_subscription_daily"><?php echo esc_html( 'Charge every', 'reepay-subscriptions' ); ?></label>
			...
			<?php echo esc_html( 'Day', 'reepay-subscriptions' ); ?>
        </p>

        <!--Monthly-->
        <p class="form-field type-fields fields-month_startdate <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_startdate"><?php echo esc_html( 'Charge every', 'reepay-subscriptions' ); ?></label>
			...
			<?php echo esc_html( 'Month', 'reepay-subscriptions' ); ?>
        </p>
        ...
        <p class="form-field type-fields fields-month_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_fixedday_day"><?php echo esc_html( 'On this day of the month', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_fixedday_period"><?php echo esc_html( 'Partial Period Handling', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_fixedday_proration"><?php echo esc_html( 'Proration setting', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_fixedday_proration_minimum"><?php echo esc_html( 'Minimum prorated amount', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_lastday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_lastday_period"><?php echo esc_html( 'Partial Period Handling', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_lastday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_lastday_proration"><?php echo esc_html( 'Proration setting', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_lastday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_lastday_proration_minimum"><?php echo esc_html( 'Minimum prorated amount', 'reepay-subscriptions' ); ?></label>
            <input type="number" min="0"
        ...
        <p class="form-field type-fields fields-primo <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_primo_period"><?php echo esc_html( 'Partial Period Handling', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-primo <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_primo_proration"><?php echo esc_html( 'Proration setting', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-primo <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_primo_proration_minimum"><?php echo esc_html( 'Minimum prorated amount', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-ultimo <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_ultimo_period"><?php echo esc_html( 'Partial Period Handling', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-ultimo <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_ultimo_proration"><?php echo esc_html( 'Proration setting', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-ultimo <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_ultimo_proration_minimum"><?php echo esc_html( 'Minimum prorated amount', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-half_yearly <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_half_yearly_period"><?php echo esc_html( 'Partial Period Handling', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-half_yearly <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_half_yearly_proration"><?php echo esc_html( 'Proration setting', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-half_yearly <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_half_yearly_proration_minimum"><?php echo esc_html( 'Minimum prorated amount', 'reepay-subscriptions' ); ?></label>
            <input type="number" min="0"
        ...
        <p class="form-field type-fields fields-month_startdate_12 <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_startdate_12_period"><?php echo esc_html( 'Partial Period Handling', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_startdate_12 <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_startdate_12_proration"><?php echo esc_html( 'Proration setting', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_startdate_12 <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_startdate_12_proration_minimum"><?php echo esc_html( 'Minimum prorated amount', 'reepay-subscriptions' ); ?></label>
            <input type="number" min="0"
        ...
        <p class="form-field type-fields fields-weekly_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_weekly_fixedday"><?php echo esc_html( 'Charge every', 'reepay-subscriptions' ); ?></label>
			...
			<?php echo esc_html( 'Week', 'reepay-subscriptions' ); ?>
        </p>
        <p class="form-field type-fields fields-weekly_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_weekly_fixedday_day"><?php echo esc_html( 'On this day of the week', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-weekly_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_weekly_fixedday_period"><?php echo esc_html( 'Partial Period Handling', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-weekly_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_weekly_fixedday_proration"><?php echo esc_html( 'Proration setting', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-weekly_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_weekly_fixedday_proration_minimum"><?php echo esc_html( 'Minimum prorated amount', 'reepay-subscriptions' ); ?></label>
            <input type="number" min="0"
        ...
        <p class="form-field advanced-fields <?php echo $variable ? 'form-row' : '' ?>">
            <label for="_reepay_subscription_default_quantity">
				<?php echo esc_html( 'Default Quantity', 'reepay-subscriptions' ); ?>
            </label>
            ...
            <input type="number" min="0" id="_reepay_subscription_default_quantity" <?php echo esc_attr( $disabled ) ?>
                   ...
                   class="wc_input_price wc_input_subscription_price"
                   placeholder="<?php echo esc_html( 'Default Quantity', 'reepay-subscriptions' ); ?>"
        ...
        <p class="form-field advanced-fields <?php echo $variable ? 'form-row' : '' ?>">
            <label for="_reepay_subscription_renewal_reminder">
				<?php echo esc_html( 'Renewal Reminder', 'reepay-subscriptions' ); ?>
            </label>
            <input type="number" min="0" id="_reepay_subscription_renewal_reminder" <?php echo esc_attr( $disabled ) ?>
                   ...
                   class="wc_input_price wc_input_subscription_price"
                   placeholder="<?php echo esc_html( 'Renewal Reminder Schedule', 'reepay-subscriptions' ); ?>"
    ...
    <div class="options_group show_if_reepay_subscription">
        <p class="form-field <?php echo $variable ? 'form-row' : '' ?>">
            <label for="_subscription_contract_periods"><?php echo esc_html( 'Minimum Contract Period', 'reepay-subscriptions' ); ?></label>
            ...
            <input type="number" min="0" id="_subscription_contract_periods" <?php echo esc_attr( $disabled ) ?>
                   ...
                   placeholder="<?php echo esc_html( 'Periods', 'reepay-subscriptions' ); ?>"
        ...
        <p class="form-field fields-contract_periods hidden">
			...
			<?php echo esc_html( 'When the subscription is created', 'reepay-subscriptions' ); ?>
			...
			<?php echo esc_html( 'When the first period starts', 'reepay-subscriptions' ); ?>
            <input <?php echo esc_attr( $disabled ) ?>
    ...
    <div class="options_group show_if_reepay_subscription">
        <p class="form-field">
            <label for="_subscription_notice_period"><?php echo esc_html( 'Notice period', 'reepay-subscriptions' ); ?></label>
			<?php echo wc_help_tip( __( 'Periods are relative to the billing frequency. If you have chosen to bill every month, a period is one month.', 'reepay-subscriptions' ) ); ?>
        ...
        <p class="form-field fields-notice_period hidden">
			...
			<?php echo esc_html( 'When the current cancelled period ends', 'reepay-subscriptions' ); ?> <input
                    type="radio"
			...
			<?php echo esc_html( 'Immediately after cancellation', 'reepay-subscriptions' ); ?> <input
                    type="radio"
                    id="_subscription_notice_period_start"
                    name="_reepay_subscription_notice_period_start<?php echo $variable ? '[' . esc_attr( $loop ) . ']' : '' ?>"
    ...
    <div class="options_group show_if_reepay_subscription billing_cycles_block">
        <p class="form-field <?php echo $variable ? 'form-row' : '' ?>">
            <label for="_subscription_billing_cycles"><?php echo esc_html( 'Billing Cycles', 'reepay-subscriptions' ); ?></label>
			<?php echo esc_html( 'Auto Renew until cancelled', 'reepay-subscriptions' ); ?> <input type="radio"
			...
			<?php echo esc_html( 'Fixed Number of billing cycles', 'reepay-subscriptions' ); ?> <input
                    type="radio"
                    id="_subscription_billing_cycles" <?php echo esc_attr( $disabled ) ?>
                    name="_reepay_subscription_billing_cycles<?php echo $variable ? '[' . esc_attr( $loop ) . ']' : '' ?>"
        ...
        <p class="form-field fields-billing_cycles <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_billing_cycles_period"><?php echo esc_html( 'Number of billing cycles', 'reepay-subscriptions' ); ?></label>
...
<?php $trial = ! empty( $_reepay_subscription_trial ) ? $_reepay_subscription_trial : [] ?>
    <div class="options_group reepay_subscription_trial show_if_reepay_subscription">
        <p class="form-field <?php echo $variable ? 'form-row' : '' ?>">
            <label for="_subscription_trial"><?php echo esc_html( 'Trial', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field trial-fields fields-customize <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_trial_length"><?php echo esc_html( 'Trial Length', 'reepay-subscriptions' ); ?></label>
            <input type="number" min="0" id="_subscription_trial_length" <?php echo esc_attr( $disabled ) ?>
                   ...
                   placeholder="<?php echo esc_html( 'Length', 'reepay-subscriptions' ); ?>"
...
<?php $fee = ! empty( $_reepay_subscription_fee ) ? $_reepay_subscription_fee : [] ?>
    <div class="options_group reepay_subscription_fee show_if_reepay_subscription">
        <p class="form-field">
            <label for="_subscription_fee"><?php echo esc_html( 'Include setup fee', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field fee-fields <?php echo $variable ? 'dimensions_field form-row' : '' ?> hidden">
            <label for="_subscription_fee_amount"><?php echo esc_html( 'Setup Fee (kr)', 'reepay-subscriptions' ); ?></label>
            <span class="wrap">
            <input type="number" min="0"
            ...
            <select id="_subscription_fee_handling" <?php echo esc_attr( $disabled ) ?> name="_reepay_subscription_fee<?php echo $variable ? '[' . esc_attr( $loop ) . ']' : '' ?>[handling]"
                    class="wc_input_subscription_period_interval">
                <option value="first" <?php echo ! empty( $fee['handling'] ) ? selected( 'first', $fee['handling'], false ) : '' ?>><?php echo esc_html( 'Include setup fee as order line on the first scheduled invoice', 'reepay-subscriptions' ); ?></option>
                <option value="separate" <?php echo ! empty( $fee['handling'] ) ? selected( 'separate', $fee['handling'], false ) : '' ?>><?php echo esc_html( 'Create a separate invoice for the setup fee', 'reepay-subscriptions' ); ?></option>
                <option value="separate_conditional" <?php echo ! empty( $fee['handling'] ) ? selected( 'separate_conditional', $fee['handling'], false ) : '' ?>><?php echo esc_html( 'Create a separate invoice for the setup fee, if the first invoice is not created in conjunction with the creation', 'reepay-subscriptions' ); ?></option>
            </select>
        </span>
        </p>
    </div>
...
<?php if ( isset( $is_exist ) && $is_exist ):
    ...
    <div class="options_group show_if_reepay_subscription reepay_subscription_supersedes_block">
        <p class="form-field <?php echo $variable ? 'supersedes_block_variable"' : '' ?>">
            <label for="_reepay_subscription_supersedes"><?php echo esc_html( 'Supersede mode', 'reepay-subscriptions' ); ?></label>
			<?php echo esc_html( "Don't schedule subscription update", 'reepay-subscriptions' ); ?>
			...
			<?php echo esc_html( 'Schedule subscription update', 'reepay-subscriptions' ); ?>
