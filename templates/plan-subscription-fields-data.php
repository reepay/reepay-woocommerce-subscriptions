...
?>
    <div class="options_group reepay_subscription_pricing show_if_reepay_subscription">
        <p class="form-field fields-name <?php echo $variable ? 'form-row' : '' ?>">
            <label for="_reepay_subscription_name"><?php esc_html_e( 'Name', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field pricing-fields <?php echo $variable ? 'dimensions_field form-row' : '' ?> ">
            <label for="_subscription_price">
				<?php esc_html_e( 'Subscription pricing (kr)', 'reepay-subscriptions' ); ?>
            </label>
            <span class="wrap">
                <input type="number"
                       ...
                       placeholder="<?php esc_attr_e( 'e.g. 5.90', 'reepay-subscriptions' ); ?>" step="any" min="0"
        ...
        <p class="form-field pricing-fields <?php echo $variable ? 'form-row' : '' ?>">
            <label for="_reepay_subscription_daily"><?php esc_html_e( 'Schedule Type', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-daily <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_reepay_subscription_daily"><?php esc_html_e( 'Charge every', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_startdate <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_startdate"><?php esc_html_e( 'Charge every', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_fixedday"><?php esc_html_e( 'Charge every', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_fixedday_period"><?php esc_html_e( 'Partial Period Handling', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_fixedday_proration"><?php esc_html_e( 'Proration setting', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_fixedday_proration_minimum"><?php esc_html_e( 'Minimum prorated amount', 'reepay-subscriptions' ); ?></label>
            <input type="number" min="0"
                   ...
                   placeholder="<?php esc_attr_e( 'kr 0.00', 'reepay-subscriptions' ); ?>"/>
        </p>
        ...
        <p class="form-field type-fields fields-month_lastday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_lastday_proration"><?php esc_html_e( 'Proration setting', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_lastday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_lastday_proration_minimum"><?php esc_html_e( 'Minimum prorated amount', 'reepay-subscriptions' ); ?></label>
            <input type="number" min="0"
        ...
        <p class="form-field type-fields fields-primo <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_primo_period"><?php esc_html_e( 'Partial Period Handling', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-primo <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_primo_proration"><?php esc_html_e( 'Proration setting', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-primo <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_primo_proration_minimum"><?php esc_html_e( 'Minimum prorated amount', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-ultimo <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_ultimo_period"><?php esc_html_e( 'Partial Period Handling', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-ultimo <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_ultimo_proration"><?php esc_html_e( 'Proration setting', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-ultimo <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_ultimo_proration_minimum"><?php esc_html_e( 'Minimum prorated amount', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-half_yearly <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_half_yearly_period"><?php esc_html_e( 'Partial Period Handling', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-half_yearly <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_half_yearly_proration"><?php esc_html_e( 'Proration setting', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-half_yearly <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_half_yearly_proration_minimum"><?php esc_html_e( 'Minimum prorated amount', 'reepay-subscriptions' ); ?></label>
            <input type="number" min="0"
        ...
        <p class="form-field type-fields fields-month_startdate_12 <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_startdate_12_period"><?php esc_html_e( 'Partial Period Handling', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_startdate_12 <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_startdate_12_proration"><?php esc_html_e( 'Proration setting', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-month_startdate_12 <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_month_startdate_12_proration_minimum"><?php esc_html_e( 'Minimum prorated amount', 'reepay-subscriptions' ); ?></label>
            <input type="number" min="0"
        ...
        <p class="form-field type-fields fields-weekly_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_weekly_fixedday_period"><?php esc_html_e( 'Partial Period Handling', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-weekly_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_weekly_fixedday_proration"><?php esc_html_e( 'Proration setting', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field type-fields fields-weekly_fixedday <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_weekly_fixedday_proration_minimum"><?php esc_html_e( 'Minimum prorated amount', 'reepay-subscriptions' ); ?></label>
            <input type="number" min="0"
        ...
        <p class="form-field advanced-fields <?php echo $variable ? 'form-row' : '' ?>">
            <label for="_reepay_subscription_default_quantity">
				<?php esc_html_e( 'Default Quantity', 'reepay-subscriptions' ); ?>
            </label>
            ...
            <input type="number" min="0" id="_reepay_subscription_default_quantity" <?php echo esc_attr( $disabled ) ?>
                   ...
                   class="wc_input_price wc_input_subscription_price"
                   placeholder="<?php esc_html_e( 'Default Quantity', 'reepay-subscriptions' ); ?>"
        ...
        <p class="form-field advanced-fields <?php echo $variable ? 'form-row' : '' ?>">
            <label for="_reepay_subscription_renewal_reminder">
				<?php esc_html_e( 'Renewal Reminder', 'reepay-subscriptions' ); ?>
            </label>
            <input type="number" min="0" id="_reepay_subscription_renewal_reminder" <?php echo esc_attr( $disabled ) ?>
                   ...
                   class="wc_input_price wc_input_subscription_price"
                   placeholder="<?php esc_html_e( 'Renewal Reminder Schedule', 'reepay-subscriptions' ); ?>"
    ...
    <div class="options_group show_if_reepay_subscription">
        <p class="form-field <?php echo $variable ? 'form-row' : '' ?>">
            <label for="_subscription_contract_periods"><?php esc_html_e( 'Minimum Contract Period', 'reepay-subscriptions' ); ?></label>
            ...
            <input type="number" min="0" id="_subscription_contract_periods" <?php echo esc_attr( $disabled ) ?>
                   ...
                   placeholder="<?php esc_html_e( 'Periods', 'reepay-subscriptions' ); ?>"
    ...
    <div class="options_group show_if_reepay_subscription">
        <p class="form-field">
            <label for="_subscription_notice_period"><?php esc_html_e( 'Notice period', 'reepay-subscriptions' ); ?></label>
			<?php echo wc_help_tip( __( 'Periods are relative to the billing frequency. If you have chosen to bill every month, a period is one month.', 'reepay-subscriptions' ) ); ?>
    ...
    <div class="options_group show_if_reepay_subscription billing_cycles_block">
        ...
        <p class="form-field fields-billing_cycles <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_billing_cycles_period"><?php esc_html_e( 'Number of billing cycles', 'reepay-subscriptions' ); ?></label>
...
<?php $trial = ! empty( $_reepay_subscription_trial ) ? $_reepay_subscription_trial : [] ?>
    <div class="options_group reepay_subscription_trial show_if_reepay_subscription">
        <p class="form-field <?php echo $variable ? 'form-row' : '' ?>">
            <label for="_subscription_trial"><?php esc_html_e( 'Trial', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field trial-fields fields-customize <?php echo $variable ? 'form-row' : '' ?> hidden">
            <label for="_subscription_trial_length"><?php esc_html_e( 'Trial Length', 'reepay-subscriptions' ); ?></label>
            <input type="number" min="0" id="_subscription_trial_length" <?php echo esc_attr( $disabled ) ?>
                   ...
                   placeholder="<?php esc_html_e( 'Length', 'reepay-subscriptions' ); ?>"
        ...
        <p class="form-field <?php echo $variable ? 'form-row' : '' ?>  trial-fields fields-7days fields-14days fields-1month fields-customize hidden">
            <label for="_subscription_billing_trial_reminder"><?php esc_html_e( 'Optional Trial Reminder Schedule', 'reepay-subscriptions' ); ?></label>
            <input type="number" min="0" id="_subscription_trial_reminder" <?php echo esc_attr( $disabled ) ?>
                   ...
                   placeholder="<?php esc_html_e( 'Days', 'reepay-subscriptions' ); ?>"
...
<?php $fee = ! empty( $_reepay_subscription_fee ) ? $_reepay_subscription_fee : [] ?>
    <div class="options_group reepay_subscription_fee show_if_reepay_subscription">
        <p class="form-field">
            <label for="_subscription_fee"><?php esc_html_e( 'Include setup fee', 'reepay-subscriptions' ); ?></label>
        ...
        <p class="form-field fee-fields <?php echo $variable ? 'dimensions_field form-row' : '' ?> hidden">
            <label for="_subscription_fee_amount"><?php esc_html_e( 'Setup Fee (kr)', 'reepay-subscriptions' ); ?></label>
            <span class="wrap">
            <input type="number" min="0"
                   ...
                   class="wc_input_price wc_input_subscription_price"
                   placeholder="<?php esc_attr_e( 'Amount', 'reepay-subscriptions' ); ?>" step="any" min="0"
            ...
            <input type="text"
                   ...
                   placeholder="<?php esc_attr_e( 'Text', 'reepay-subscriptions' ); ?>"
            ...
            <select id="_subscription_fee_handling" <?php echo esc_attr( $disabled ) ?> name="_reepay_subscription_fee<?php echo $variable ? '[' . esc_attr( $loop ) . ']' : '' ?>[handling]"
                    class="wc_input_subscription_period_interval">
                <option value="first" <?php echo ! empty( $fee['handling'] ) ? selected( 'first', $fee['handling'], false ) : '' ?>><?php esc_html_e( 'Include setup fee as order line on the first scheduled invoice', 'reepay-subscriptions' ); ?></option>
                <option value="separate" <?php echo ! empty( $fee['handling'] ) ? selected( 'separate', $fee['handling'], false ) : '' ?>><?php esc_html_e( 'Create a separate invoice for the setup fee', 'reepay-subscriptions' ); ?></option>
                <option value="separate_conditional" <?php echo ! empty( $fee['handling'] ) ? selected( 'separate_conditional', $fee['handling'], false ) : '' ?>><?php esc_html_e( 'Create a separate invoice for the setup fee, if the first invoice is not created in conjunction with the creation', 'reepay-subscriptions' ); ?></option>
            </select>
        </span>
        </p>
    </div>
